...
const OrderInfo = ({deliveryFee, cartTotal, cartItems, handlePayment} : {deliveryFee: number, cartTotal: number, cartItems: [CartItem], handlePayment: any}) => {
    ...
    <>
      ...
      <div className= {styles.container}>
        ...
        <div className= {styles.pay}>
          <Button 
            variant = 'contained' 
            sx={{borderRadius: '20px', backgroundColor: 'var(--color-primary)', width: '100%'}}
